...
const MONSTROS = [
    ...
    { id: 2, nome: "Promos", tribo: "Azul", tipoClasse: "Subordinado", raridade: 0.7, elementos: [], fichasHabilidade: 3, temEfeito: false, textoCarta: "Promos e o Promoscentismo.", cartaBlank: "cartas/criaturas/azul/promos.png", iconeMapa: "cartas/icones/promos_perfil.png", statsMax: { coragem: 40, poder: 40, sabedoria: 80, velocidade: 60, energia: 25 } },
    { id: 3, nome: "Alakazaz", tribo: "Azul", tipoClasse: "Mago", raridade: 0.6, elementos: [], fichasHabilidade: 5, temEfeito: true, textoCarta: "Você pode pegar as fichas de habilidade deste campeão e distribuir elas entre os campeões que você controla.", cartaBlank: "cartas/criaturas/azul/alakazaz.png", iconeMapa: "cartas/icones/alakazaz_perfil.png", statsMax: { coragem: 50, poder: 20, sabedoria: 80, velocidade: 25, energia: 10 } },
    ...
    { id: 5, nome: "Ferez", tribo: "Azul", tipoClasse: "Guerreiro", raridade: 0.7, elementos: ["Água"], fichasHabilidade: 0, temEfeito: false, textoCarta: "Vive nas terras mais geladas da tribo azul.", cartaBlank: "cartas/criaturas/azul/ferez.png", iconeMapa: "cartas/icones/ferez_perfil.png", statsMax: { coragem: 35, poder: 65, sabedoria: 70, velocidade: 45, energia: 40 } },
    ...
    { id: 10, nome: "Leona", tribo: "Azul", tipoClasse: "Guerreiro", raridade: 0.7, elementos: ["Água"], fichasHabilidade: 1, temEfeito: true, textoCarta: "HABILIDADE: toda vez que esse campeão atacar ele causa 5 de dano em qualquer campeão.", cartaBlank: "cartas/criaturas/azul/leona.png", iconeMapa: "cartas/icones/leona_perfil.png", statsMax: { coragem: 30, poder: 25, sabedoria: 30, velocidade: 45, energia: 35 } },
    { id: 11, nome: "Lion", tribo: "Azul", tipoClasse: "Guerreiro", raridade: 0.6, elementos: ["Fogo", "Terra"], fichasHabilidade: 1, temEfeito: true, textoCarta: "HABILIDADE: Descarte 1 ficha de habilidade de Lion e aumente a sua energia em 10.", cartaBlank: "cartas/criaturas/azul/lion.png", iconeMapa: "cartas/icones/lion_perfil.png", statsMax: { coragem: 30, poder: 35, sabedoria: 30, velocidade: 20, energia: 25 } },
