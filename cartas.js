...
const MONSTROS = [
    ...
    { id: 12, nome: "Naty", tribo: "Azul", tipoClasse: "Mago", raridade: 0.5, elementos: [], fichasHabilidade: 3, temEfeito: true, precisaAlvo: false, efeitoId: "resetar_naty", textoCarta: "HABILIDADE: Na primeira vez que este campeão batalhar, ele ganha os 4 elementos, na segunda vez 3 elementos de sua escolha, na terceira vez 2 elementos de sua escolha, na quarta vez 1 elemento de sua escolha, descarte 1 ficha de habilidade deste campeão para renovar os efeitos deste campeão.", cartaBlank: "cartas/criaturas/azul/naty.png", iconeMapa: "cartas/icones/naty_perfil.png", statsMax: { coragem: 25, poder: 30, sabedoria: 60, velocidade: 65, energia: 35 } },
