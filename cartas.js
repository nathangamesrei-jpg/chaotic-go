...
const MONSTROS = [
    ...
    { id: 3, nome: "Alakazaz", tribo: "Azul", tipoClasse: "Mago", raridade: 0.1, elementos: [], fichasHabilidade: 5, temEfeito: true, precisaAlvo: true, textoCarta: "Você pode pegar as fichas de habilidade deste campeão e distribuir elas entre os campeões que você controla.", cartaBlank: "cartas/criaturas/azul/alakazaz.png", iconeMapa: "cartas/icones/alakazaz_perfil.png", statsMax: { coragem: 50, poder: 20, sabedoria: 80, velocidade: 25, energia: 10 } },
