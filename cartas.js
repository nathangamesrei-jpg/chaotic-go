...
const MONSTROS = [
    ...
    { id: 6, nome: "Frador", tribo: "Azul", tipoClasse: "Guerreiro", raridade: 0.1, elementos: [], fichasHabilidade: 1, temEfeito: true, efeitoId: "dano_25", precisaAlvo: true, textoCarta: "Descarte 2 fichas de habilidade desse campeão, em sequência cause 25 de dano a um campeão do seu oponente.", cartaBlank: "cartas/criaturas/azul/frador.png", iconeMapa: "cartas/icones/frador_perfil.png", statsMax: { coragem: 85, poder: 80, sabedoria: 45, velocidade: 75, energia: 35 } },
