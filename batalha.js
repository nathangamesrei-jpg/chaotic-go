...
function desenharMiniCarta(criaturaObj) {
    ...
    if (criaturaObj) {
        ...
        // Se o inventário antigo do cara não salvou os elementos, busca direto na fonte
...
window.carregarDeckParaBatalha = function(salaId, souP1) {
    ...
    window.deckInimigoMontado = false;
...
// 🔥 FUNÇÃO NOVA QUE JOGA A MAGIA NO LIXO E ATIVA O MODO ALVO
...
window.lidarComCliqueTabuleiro = function(fullId) {
    ...
    if (window.modoAlvo) {
        ...
        if (ctx.tipo === 'habilidade') {
            ...
            // 🔥 NUVEM: ENVIA A MAGIA PRO LIXO DO OPONENTE
