...
window.ajustarTabuleiroBatalha = function(modo) {
    ...
    if (modo === "6x6") {
        ...
        if(jogLinha1) jogLinha1.style.marginTop = "8px"; // Empurra o jogador 10px pra baixo
        if(opLinha1) opLinha1.style.marginTop = "8px";   // Empurra o oponente 10px (visualmente) pra cima
